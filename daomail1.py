...
def checkhotmail():
  ...
  try:
    ...
    print (" \033[1;31mĐÉO CÓ FILE NÀO NHƯ THẾ CẢ !")
    quit()
  list_hotmail = []
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m✡ |\033[1;37m NAM\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m✡ |\033[1;37m NAM\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37m NAM\033[1;32m|Mail Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37m NAM\033[1;31m|Mail Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m[ Tool Check Valid FB ]')
  print ('')
  try:
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m✡ |\033[1;37m NAM\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m✡ |\033[1;37m NAM\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
"""
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  choice_user = input("\033[1;34m✡ Chọn Số Thứ Tự Cần Dùng : ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
